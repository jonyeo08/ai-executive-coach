      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex space-x-4">
            ...
            <Link href="/marketplace" className="flex items-center px-3 py-2 rounded-md text-gray-700 hover:bg-indigo-50 transition-all duration-200 transform hover:scale-105">
